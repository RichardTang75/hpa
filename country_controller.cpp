...
//		path_with_cost path=hierarchical_pathfind(to, from, t_mobility, mapset, max_depth, cut_size, nodes);
//    }
...
//                {
//                    move(tuple_int(new_x,new_y), nodes, mapset, max_depth, cut_size);
//                }
//                else
//                {
//                    new_x-=dx;
